...
```mermaid
graph TD
    A[User Lands] --> B{Language Selected?}
    B -- No --> C[Namaste Welcome Screen]
    C --> D[Language Selection]
    D --> E[Global Language Context]
    B -- Yes --> F[Main Dashboard]
    F --> G[AI Chat Panel]
    F --> H[Journey Flow]
    F --> I[Election Timeline]
    G <--> J[Groq SDK / Llama 3.3]
    H --> K[Quiz Section]
```
...
<div align="center">
  <table border="0">
    <tr>
      <td><img src="public/images/voter-id.png" width="350" alt="Voter ID" /><br/><p align="center"><i>Voter Journey</i></p></td>
      <td><img src="public/images/inked-finger.png" width="350" alt="Inked Finger" /><br/><p align="center"><i>Election Pride</i></p></td>
    </tr>
    <tr>
      <td colspan="2"><img src="public/images/evm.png" width="715" alt="EVM Guide" /><br/><p align="center"><i>Electronic Voting Machine Guide</i></p></td>
    </tr>
  </table>
</div>
...
<div align="center">
  ...
  <br/>
  <img src="https://img.shields.io/badge/Made%20with%20%E2%9D%A4%20in-India-orange?style=for-the-badge" />
</div>
